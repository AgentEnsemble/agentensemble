...
mapOf(
    ...
    "runLoopReflection" to "net.agentensemble.examples.LoopReflectionExample",
    "runLoopRetryUntilValid" to "net.agentensemble.examples.LoopRetryUntilValidExample",
    "runGraphRouter" to "net.agentensemble.examples.GraphRouterExample",
    "runGraphRetryWithFallback" to "net.agentensemble.examples.GraphRetryWithFallbackExample",
