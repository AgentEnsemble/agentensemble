...
|---|---|---|
| Design document | `docs/design/24-ensemble-network.md` | Full engineering spec (24 sections) |
| Issue breakdown | `docs/design/24-ensemble-network-issues.md` | 30 issues across 4 phases |
