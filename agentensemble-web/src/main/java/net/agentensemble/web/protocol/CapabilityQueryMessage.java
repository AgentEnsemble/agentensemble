 ...
 *
 * <p>Sent by an ensemble to query for available capabilities by name, tag, or type.
 ...
 * @param type      optional type filter ({@code "TASK"} or {@code "TOOL"}); null means any
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public record CapabilityQueryMessage(String requestId, String from, String toolName, String tag, String type)
