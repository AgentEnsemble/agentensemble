...
public class Ensemble {
     ...
     *
     * Use the builder's {@link EnsembleBuilder#listener(EnsembleListener)} or
     * {@link EnsembleBuilder#listeners(java.util.Collection)} methods to add full listener
     ...
     * and delegates to {@link #listener(EnsembleListener)}, which is generated by Lombok's
