...
/**
 * Unit tests for {@link NetworkTask} request mode behavior (AWAIT, ASYNC, AWAIT_WITH_DEADLINE).
 */
class NetworkTaskRequestModeTest {
    ...
    void asyncMode_callbackFiresOnCompletion() throws Exception {
        ...
        ToolResult immediateResult = task.execute("make a salad");
        ...
        assertThat(callbackResult.get().getOutput()).isEqualTo("Meal ready");
    }
